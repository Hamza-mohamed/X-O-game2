...
# Define the dimensions  and image of screen object
screen = pygame.display.set_mode((300, 400))

ico = pygame.image.load('icon1.jpg')
icon = pygame.transform.scale(ico, (32, 32))
pygame.display.set_icon(icon)
pygame.display.set_caption('Player 1: Hamza')
host1 = '127.0.0.10'
port1 = 8080
pygame.init()
score = 0
...
myFont2 = pygame.font.SysFont("Times New Roman", 18)
...
def main():
    ...
    # two rect to hold the scoring
    scorepos = pygame.draw.rect(screen, (255, 255, 255), (150, 300, 150, 150))
    svalue = pygame.draw.rect(screen, (255, 255, 255), (0, 300, 150, 150))
    ...
    pygame.draw.line(screen, (0, 0, 0),  (0,300) , (300, 300))
    pygame.draw.line(screen, (0, 0, 0),(150, 300),(150, 400))
...
#load images
    ...
    pygame.display.flip()
    while 1:
        # for every click increase d value with one
        d += 1
# establish connection
        ...
        if ((s1 == 1 & s2 == 1 & s3 == 1) | (s1 == 1 & s4 == 1 & s7 == 1) | (s1 == 1 & s5 == 1 & s9 == 1) | (
                s2 == 1 & s5 == 1 & s8 == 1) | (s3 == 1 & s5 == 1 & s7 == 1) | (s3 == 1 & s6 == 1 & s9 == 1) | (
                s4 == 1 & s5 == 1 & s6 == 1) | (s7 == 1 & s8 == 1 & s9 == 1)):
            global score
            global myFont
            score += 1
            scoring = myFont.render("player 1 score is :" + str(score), 1, (0, 0, 0))
            screen.blit(scoring, [2, 330])
            screen.blit(win1, [0, 0])
            pygame.display.flip()
            time.sleep(5)
            main()
        if ((s1 == 2 & s2 == 2 & s3 == 2) | (s1 == 2 & s4 == 2 & s7 == 2) | (s1 == 2 & s5 == 2 & s9 == 2) | (
                s2 == 2 & s5 == 2 & s8 == 2) | (s3 == 2 & s5 == 2 & s7 == 2) | (s3 == 2 & s6 == 2 & s9 == 2) | (
                s4 == 2 & s5 == 2 & s6 == 2) | (s7 == 2 & s8 == 2 & s9 == 2)):
        ...
        if ((s1 == 2 & s2 == 2 & s3 == 2) | (s1 == 2 & s4 == 2 & s7 == 2) | (s1 == 2 & s5 == 2 & s9 == 2) | (
            ...
            global myFont2
            score2 += 1
            scoring = myFont2.render('player 2 score is :' + str(score2), 1, (0, 0, 0))
            screen.blit(scoring, [152, 330])
            screen.blit(win2, [0, 0])
            pygame.display.flip()
            time.sleep(5)
            main()
